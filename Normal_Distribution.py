...
list_of_data_within_1_std_deviation = [result for result in data if result > first_start and result < first_end]
list_of_data_within_2_std_deviation = [result for result in data if result > second_start and result < second_end]
list_of_data_within_3_std_deviation = [result for result in data if result > third_start and result < third_end]
